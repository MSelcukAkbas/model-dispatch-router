Scope: frontend, UI, design-system, and presentation files explicitly named by the task or the project's model-dispatch-router configuration. Do not modify backend, SDK, or infrastructure files unless the task explicitly includes them.
