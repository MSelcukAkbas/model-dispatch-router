Scope: backend and service-side files explicitly named by the task or the project's model-dispatch-router configuration. Do not cross into UI, SDK, infrastructure, or unrelated services unless the task explicitly includes them.
