Scope: client libraries, SDKs, examples, and compatibility layers explicitly named by the task or the project's model-dispatch-router configuration. Do not modify service or UI code unless the task explicitly includes it.
