...
An orchestration kernel for the `model-dispatch-route` / `graphify` / `agentic-ssh-mcp`
...
`skills/model-dispatch-route/mcp/agentmind/` gives you the test environment.
...
```
agentmind/                                  repo root
├── skills/model-dispatch-route/                orchestration skill
